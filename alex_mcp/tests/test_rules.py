...
from alex_mcp.rules.parksy_forbidden import scan, has_critical_forbidden
from alex_mcp.rules.parksy_negative import risk_score, should_regenerate
...
class TestNegative:
    ...
    def test_textbook_high_risk(self):
        ...
        from alex_mcp.rules.parksy_forbidden import has_critical_forbidden
        assert has_critical_forbidden(TEXTBOOK_EXAMPLE)
